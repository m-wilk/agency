  ...
  return (
    <div className="bg-black py-20">
      <div className="grid grid-rows-1  grid-cols-2 gap-4 container">
        ...
        <div className="ms-24">
          <div className="flex items-center gap-3 text-primary border border-white rounded-full px-6 py-3 inline-flex mb-8">
            <span className="uppercase">About Company</span>
          ...
          <div className="flex justify-between mb-8">
            <h5 className="text-primary text-2xl font-bold">2019</h5>
            <h5 className="text-primary text-2xl font-bold">2021</h5>
            <h5 className="text-primary text-2xl font-bold">2024</h5>
          </div>
